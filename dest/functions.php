 ...
 */
function oss_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'oss_content_width', 640 );
}
add_action( 'after_setup_theme', 'oss_content_width', 0 );
...
function oss_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'oss' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'oss' ),
...
function oss_scripts() {
	...
	wp_enqueue_script( 'oss-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'oss-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
